...
export const PATIENTS = [
  { id: 1, mr_number: 'MR-2024-001', full_name: 'Ahmed Hassan', first_name: 'Ahmed', last_name: 'Hassan', age: 72, date_of_birth: '1952-04-10', gender: 'M', gender_display: 'Male', primary_diagnosis: 'Type 2 Diabetes with Diabetic Foot Ulcer', phone: '+92-21-111-0001', address: 'B-14, Gulshan-e-Iqbal Block 7, Karachi', latitude: 24.8620, longitude: 67.0100, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 2, mr_number: 'MR-2024-002', full_name: 'Fatima Zahra', first_name: 'Fatima', last_name: 'Zahra', age: 58, date_of_birth: '1966-09-23', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Post-Stroke Rehabilitation (Left Hemiplegia)', phone: '+92-21-111-0002', address: 'A-7, DHA Phase 5, Karachi', latitude: 24.8700, longitude: 67.0190, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 3, mr_number: 'MR-2024-003', full_name: 'Khalid Mehmood', first_name: 'Khalid', last_name: 'Mehmood', age: 65, date_of_birth: '1959-01-15', gender: 'M', gender_display: 'Male', primary_diagnosis: 'COPD Stage III + CHF', phone: '+92-21-111-0003', address: '37-C, North Nazimabad Block F, Karachi', latitude: 24.8450, longitude: 67.0340, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 4, mr_number: 'MR-2024-004', full_name: 'Nadia Alam', first_name: 'Nadia', last_name: 'Alam', age: 45, date_of_birth: '1979-06-30', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Major Depressive Disorder + GAD', phone: '+92-21-111-0004', address: 'House 8, Clifton Block 4, Karachi', latitude: 24.8430, current_longitude: 67.0360, latitude: 24.8430, longitude: 67.0360, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 5, mr_number: 'MR-2024-005', full_name: 'Hassan Ali', first_name: 'Hassan', last_name: 'Ali', age: 80, date_of_birth: '1944-12-01', gender: 'M', gender_display: 'Male', primary_diagnosis: 'Alzheimer\'s Disease Moderate Stage', phone: '+92-21-111-0005', address: 'F-22, Federal B Area Block 14, Karachi', latitude: 24.8580, longitude: 67.0070, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 6, mr_number: 'MR-2024-006', full_name: 'Rukhsana Begum', first_name: 'Rukhsana', last_name: 'Begum', age: 55, date_of_birth: '1969-03-19', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Post-Total Knee Replacement Physiotherapy', phone: '+92-21-111-0006', address: 'Plot 12, Johar Town Block 3, Karachi', latitude: 24.8730, longitude: 67.0270, assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
];
...
export const BOOKINGS = [
  { id: 1001, patient: PATIENTS[0], patient_name: 'Ahmed Hassan', patient_mr: 'MR-2024-001', assigned_staff: STAFF[0], staff_name: 'Sarah Mitchell', service_type: 'long_term', service_type_display: 'Long-Term Care', status: 'in_progress', status_display: 'In Progress', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: subMins(45), actual_start_time: subMins(38), actual_end_time: null, address: 'B-14, Gulshan-e-Iqbal Block 7, Karachi', latitude: 24.8620, longitude: 67.0100, amount: 2500, amount_paid: 2500, balance_due: 0, notes: 'Daily wound dressing, blood glucose monitoring, insulin administration', created_at: subDays(2) },
  { id: 1002, patient: PATIENTS[1], patient_name: 'Fatima Zahra', patient_mr: 'MR-2024-002', assigned_staff: STAFF[1], staff_name: 'Dr. Raza Khan', service_type: 'long_term', service_type_display: 'Long-Term Care', status: 'en_route', status_display: 'En Route', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: addMins(10), actual_start_time: null, actual_end_time: null, address: 'A-7, DHA Phase 5, Karachi', latitude: 24.8700, longitude: 67.0190, amount: 3500, amount_paid: 3500, balance_due: 0, notes: 'Neurological assessment, physio coordination', created_at: subDays(3) },
  { id: 1003, patient: PATIENTS[2], patient_name: 'Khalid Mehmood', patient_mr: 'MR-2024-003', assigned_staff: null, staff_name: null, service_type: 'short_service', service_type_display: 'Short Service', status: 'pending', status_display: 'Pending', payment_status: 'pending', payment_status_display: 'Payment Pending', scheduled_time: addMins(30), actual_start_time: null, actual_end_time: null, address: '37-C, North Nazimabad Block F, Karachi', latitude: 24.8450, longitude: 67.0340, amount: 1200, amount_paid: 0, balance_due: 1200, notes: 'Nebulisation + SpO2 check', created_at: subMins(120) },
  { id: 1004, patient: PATIENTS[3], patient_name: 'Nadia Alam', patient_mr: 'MR-2024-004', assigned_staff: STAFF[4], staff_name: 'Dr. Layla Noor', service_type: 'long_term', service_type_display: 'Long-Term Care', status: 'in_progress', status_display: 'In Progress', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: subMins(60), actual_start_time: subMins(55), actual_end_time: null, address: 'House 8, Clifton Block 4, Karachi', latitude: 24.8430, longitude: 67.0360, amount: 4000, amount_paid: 4000, balance_due: 0, notes: 'Weekly therapy session — CBT protocol', created_at: subDays(7) },
  { id: 1005, patient: PATIENTS[4], patient_name: 'Hassan Ali', patient_mr: 'MR-2024-005', assigned_staff: STAFF[3], staff_name: 'Imran Siddiqui', service_type: 'long_term_admission', service_type_display: 'Long-Term Admission', status: 'assigned', status_display: 'Assigned', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: addMins(90), actual_start_time: null, actual_end_time: null, address: 'F-22, Federal B Area Block 14, Karachi', latitude: 24.8580, longitude: 67.0070, amount: 5000, amount_paid: 5000, balance_due: 0, notes: 'Morning care, medication, fall prevention assessment', created_at: subDays(1) },
  { id: 1006, patient: PATIENTS[5], patient_name: 'Rukhsana Begum', patient_mr: 'MR-2024-006', assigned_staff: STAFF[2], staff_name: 'Amina Farooq', service_type: 'long_term', service_type_display: 'Long-Term Care', status: 'completed', status_display: 'Completed', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: subHours(3), actual_start_time: subHours(3), actual_end_time: subMins(90), address: 'Plot 12, Johar Town Block 3, Karachi', latitude: 24.8730, longitude: 67.0270, amount: 2000, amount_paid: 2000, balance_due: 0, notes: 'ROM exercises, gait training with walker', created_at: subDays(5) },
  { id: 1007, patient: PATIENTS[0], patient_name: 'Ahmed Hassan', patient_mr: 'MR-2024-001', assigned_staff: STAFF[0], staff_name: 'Sarah Mitchell', service_type: 'medicine_delivery', service_type_display: 'Medicine Delivery', status: 'completed', status_display: 'Completed', payment_status: 'advance', payment_status_display: 'Advance Paid', scheduled_time: subDays(1), actual_start_time: subDays(1), actual_end_time: new Date(subDays(1)).toISOString(), address: 'B-14, Gulshan-e-Iqbal Block 7, Karachi', latitude: 24.8620, longitude: 67.0100, amount: 800, amount_paid: 800, balance_due: 0, notes: 'Monthly insulin + dressings delivery', created_at: subDays(2) },
  { id: 1008, patient: PATIENTS[1], patient_name: 'Fatima Zahra', patient_mr: 'MR-2024-002', assigned_staff: null, staff_name: null, service_type: 'short_service', service_type_display: 'Short Service', status: 'pending', status_display: 'Pending', payment_status: 'pending', payment_status_display: 'Payment Pending', scheduled_time: addMins(180), actual_start_time: null, actual_end_time: null, address: 'A-7, DHA Phase 5, Karachi', latitude: 24.8700, longitude: 67.0190, amount: 1500, amount_paid: 0, balance_due: 1500, notes: 'Blood draw for monthly labs', created_at: subMins(30) },
];

export const GEOFENCE_EVENTS = [
  { id: 1, booking: BOOKINGS[0], booking_id: 1001, staff: STAFF[0], staff_name: 'Sarah Mitchell', patient_name: 'Ahmed Hassan', event_type: 'check_in', event_type_display: 'Check In (Arrived)', timestamp: subMins(38), latitude: 24.8621, longitude: 67.0101, visit_duration_minutes: null },
  { id: 2, booking: BOOKINGS[5], booking_id: 1006, staff: STAFF[2], staff_name: 'Amina Farooq', patient_name: 'Rukhsana Begum', event_type: 'check_in', event_type_display: 'Check In (Arrived)', timestamp: subHours(3), latitude: 24.8731, longitude: 67.0271, visit_duration_minutes: null },
  { id: 3, booking: BOOKINGS[5], booking_id: 1006, staff: STAFF[2], staff_name: 'Amina Farooq', patient_name: 'Rukhsana Begum', event_type: 'check_out', event_type_display: 'Check Out (Departed)', timestamp: subMins(90), latitude: 24.8730, longitude: 67.0270, visit_duration_minutes: 90 },
  { id: 4, booking: BOOKINGS[3], booking_id: 1004, staff: STAFF[4], staff_name: 'Dr. Layla Noor', patient_name: 'Nadia Alam', event_type: 'check_in', event_type_display: 'Check In (Arrived)', timestamp: subMins(55), latitude: 24.8431, longitude: 67.0361, visit_duration_minutes: null },
  { id: 5, booking: BOOKINGS[1], booking_id: 1002, staff: STAFF[1], staff_name: 'Dr. Raza Khan', patient_name: 'Fatima Zahra', event_type: 'en_route', event_type_display: 'En Route', timestamp: subMins(15), latitude: 24.8680, longitude: 67.0210, visit_duration_minutes: null },
];

export const SOS_EVENTS = [
  { id: 1, booking: BOOKINGS[0], booking_id: 1001, staff: STAFF[0], staff_name: 'Sarah Mitchell', patient_name: 'Ahmed Hassan', triggered_at: subMins(5), latitude: 24.8621, longitude: 67.0101, status: 'active', status_display: 'Active', resolved_at: null, notes: '' },
];

export const ALERTS = [
  { id: 'a1', type: 'sos',     severity: 'critical', title: 'SOS Alert — Sarah Mitchell',    message: 'SOS triggered during visit at Ahmed Hassan (MR-2024-001). GPS: 24.8621, 67.0101', time: subMins(5),  dismissible: true },
...
export const ROLE_CONFIG = {
  super_admin:     { label: 'Super Admin',     nav: ['overview', 'bookings', 'live-tracking', 'staff', 'patients', 'therapy', 'admin-hr', 'accounts', 'billing', 'crm', 'reports', 'analytics', 'users'] },
  admin:           { label: 'Admin',           nav: ['overview', 'bookings', 'live-tracking', 'staff', 'patients', 'therapy', 'admin-hr', 'accounts', 'billing', 'crm', 'reports', 'analytics', 'users'] },
  branch_manager:  { label: 'Branch Manager',  nav: ['overview', 'bookings', 'live-tracking', 'staff', 'patients', 'reports', 'analytics', 'users'] },
...
export const SYSTEM_USERS = [
  { id: 1, full_name: 'Super Administrator', email: 'admin@homecareos.com', phone: '+92-300-0000000', role: 'super_admin', role_display: 'Super Admin', branch: 'Head Office (Karachi)', status: 'active', last_login: '2026-08-28 11:30' },
  { id: 2, full_name: 'Shahzaib Ahmed', email: 'shahzaib.a@homecareos.com', phone: '+92-300-1112233', role: 'admin', role_display: 'Admin', branch: 'Clifton Branch', status: 'active', last_login: '2026-08-28 10:15' },
  { id: 3, full_name: 'Hina Malik', email: 'hina.m@homecareos.com', phone: '+92-300-8901234', role: 'care_manager', role_display: 'Care Manager', branch: 'Gulshan Branch', status: 'active', last_login: '2026-08-27 16:45' },
  { id: 4, full_name: 'Tariq Mehmood', email: 'tariq.m@homecareos.com', phone: '+92-321-4445566', role: 'branch_manager', role_display: 'Branch Manager', branch: 'DHA Branch', status: 'active', last_login: '2026-08-26 09:20' },
  { id: 5, full_name: 'Sarah Mitchell', email: 'sarah.m@homecareos.com', phone: '+92-300-1234567', role: 'nurse', role_display: 'Nurse', branch: 'Gulshan Branch', status: 'active', last_login: '2026-08-28 08:00' },
  { id: 6, full_name: 'Fariha Yasmin', email: 'fariha.y@homecareos.com', phone: '+92-333-7778899', role: 'accountant', role_display: 'Accountant', branch: 'Head Office (Karachi)', status: 'active', last_login: '2026-08-28 11:10' },
  { id: 7, full_name: 'Usman Chaudhry', email: 'usman.c@homecareos.com', phone: '+92-345-9990011', role: 'crm_executive', role_display: 'CRM Executive', branch: 'Head Office (Karachi)', status: 'active', last_login: '2026-08-27 14:00' },
  { id: 8, full_name: 'Kamran Sheikh', email: 'kamran.s@homecareos.com', phone: '+92-301-3332211', role: 'admin', role_display: 'Admin', branch: 'North Nazimabad Branch', status: 'suspended', last_login: '2026-07-15 12:00' },
];

...
export const STAFF = [
  ...
  // ── 5 New Staff Members ───────────────────────────────────────────────────
  { id: 9,  full_name: 'Sana Qureshi',     first_name: 'Sana',     last_name: 'Qureshi',   employee_id: 'EMP009', role: 'nurse',        role_display: 'Nurse',                   specialization: 'Critical Care & ICU Step-Down',   status: 'available', status_display: 'Available', phone: '+92-300-9012345', email: 'sana.q@homecareos.com',   rating: 4.8, hire_date: '2023-06-01', current_latitude: 33.5665, current_longitude: 73.1555, location_updated_at: new Date().toISOString() },
  { id: 10, full_name: 'Dr. Bilal Ahmed',  first_name: 'Bilal',    last_name: 'Ahmed',     employee_id: 'EMP010', role: 'doctor',       role_display: 'Doctor',                  specialization: 'Cardiology & Hypertension Mgmt',  status: 'on_visit',  status_display: 'On Visit',  phone: '+92-300-0123456', email: 'bilal.a@homecareos.com',  rating: 4.9, hire_date: '2020-05-15', current_latitude: 33.5742, current_longitude: 73.1498, location_updated_at: new Date().toISOString() },
  { id: 11, full_name: 'Mariam Sheikh',    first_name: 'Mariam',   last_name: 'Sheikh',    employee_id: 'EMP011', role: 'nurse',        role_display: 'Nurse',                   specialization: 'Pediatric & Maternal Care',       status: 'on_leave',  status_display: 'On Leave',  phone: '+92-301-1234567', email: 'mariam.s@homecareos.com', rating: 4.6, hire_date: '2024-01-10', current_latitude: null,    current_longitude: null,    location_updated_at: null },
  { id: 12, full_name: 'Ali Hassan Rizvi', first_name: 'Ali',      last_name: 'Rizvi',     employee_id: 'EMP012', role: 'physio',       role_display: 'Physiotherapist',         specialization: 'Neurological Rehab & Stroke Rec', status: 'available', status_display: 'Available', phone: '+92-301-2345678', email: 'ali.r@homecareos.com',    rating: 4.7, hire_date: '2022-11-20', current_latitude: 33.5700, current_longitude: 73.1480, location_updated_at: new Date().toISOString() },
  { id: 13, full_name: 'Nadia Rehman',     first_name: 'Nadia',    last_name: 'Rehman',    employee_id: 'EMP013', role: 'care_manager', role_display: 'Client Care Manager',     specialization: 'Oncology & Palliative Coordination', status: 'available', status_display: 'Available', phone: '+92-301-3456789', email: 'nadia.r@homecareos.com',  rating: 4.8, hire_date: '2021-09-05', current_latitude: null,    current_longitude: null,    location_updated_at: null },
];

export const PATIENTS = [
  { id: 1,  mr_number: 'MR-2024-001', full_name: 'Ahmed Hassan',    first_name: 'Ahmed',    last_name: 'Hassan',   age: 72, date_of_birth: '1952-04-10', gender: 'M', gender_display: 'Male',   primary_diagnosis: 'Type 2 Diabetes with Diabetic Foot Ulcer',          phone: '+92-51-111-0001', address: 'House 14, Block C, Soan Garden, Islamabad',          latitude: 33.5620, longitude: 73.1530, allergies: 'Penicillin',     blood_type: 'B+', assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 2,  mr_number: 'MR-2024-002', full_name: 'Fatima Zahra',    first_name: 'Fatima',   last_name: 'Zahra',    age: 58, date_of_birth: '1966-09-23', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Post-Stroke Rehabilitation (Left Hemiplegia)',      phone: '+92-51-111-0002', address: 'House 27, Street 4, Sector B, PWD Society, Islamabad', latitude: 33.5750, longitude: 73.1510, allergies: 'NKDA',           blood_type: 'O+', assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 3,  mr_number: 'MR-2024-003', full_name: 'Khalid Mehmood',  first_name: 'Khalid',   last_name: 'Mehmood',  age: 65, date_of_birth: '1959-01-15', gender: 'M', gender_display: 'Male',   primary_diagnosis: 'COPD Stage III + CHF',                              phone: '+92-51-111-0003', address: 'House 8-A, Block D, Soan Garden, Islamabad',         latitude: 33.5640, longitude: 73.1550, allergies: 'Sulfa drugs',    blood_type: 'A+', assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 4,  mr_number: 'MR-2024-004', full_name: 'Nadia Alam',      first_name: 'Nadia',    last_name: 'Alam',     age: 45, date_of_birth: '1979-06-30', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Major Depressive Disorder + GAD',                   phone: '+92-51-111-0004', address: 'Plot 104, Main Double Road, PWD, Islamabad',          latitude: 33.5770, longitude: 73.1490, allergies: 'NKDA',           blood_type: 'AB+',assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 5,  mr_number: 'MR-2024-005', full_name: 'Hassan Ali',      first_name: 'Hassan',   last_name: 'Ali',      age: 80, date_of_birth: '1944-12-01', gender: 'M', gender_display: 'Male',   primary_diagnosis: "Alzheimer's Disease Moderate Stage",              phone: '+92-51-111-0005', address: 'House 45, Street 12, Block A, Soan Garden, Islamabad', latitude: 33.5610, longitude: 73.1510, allergies: 'Aspirin',        blood_type: 'O-', assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  { id: 6,  mr_number: 'MR-2024-006', full_name: 'Rukhsana Begum',  first_name: 'Rukhsana', last_name: 'Begum',    age: 55, date_of_birth: '1969-03-19', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Post-Total Knee Replacement Physiotherapy',         phone: '+92-51-111-0006', address: 'House 19, Block C-1, PWD Housing Society, Islamabad', latitude: 33.5720, longitude: 73.1530, allergies: 'NKDA',           blood_type: 'A-', assigned_care_manager: STAFF[7], care_manager_name: 'Hina Malik', is_active: true },
  // ── 5 New Patients ────────────────────────────────────────────────────────
  { id: 7,  mr_number: 'MR-2024-007', full_name: 'Tariq Mahmood',   first_name: 'Tariq',    last_name: 'Mahmood',  age: 68, date_of_birth: '1956-07-22', gender: 'M', gender_display: 'Male',   primary_diagnosis: 'Hypertensive Heart Disease + Stage 3 CKD',          phone: '+92-51-111-0007', address: 'House 33, Street 7, G-10/1, Islamabad',              latitude: 33.5680, longitude: 73.1445, allergies: 'NSAIDs',         blood_type: 'B-', assigned_care_manager: STAFF[12], care_manager_name: 'Nadia Rehman', is_active: true, emergency_contact_name: 'Asim Mahmood', emergency_contact_phone: '+92-300-9911111' },
  { id: 8,  mr_number: 'MR-2024-008', full_name: 'Saira Bano',      first_name: 'Saira',    last_name: 'Bano',     age: 34, date_of_birth: '1990-11-05', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Breast Cancer Post-Chemotherapy Recovery',          phone: '+92-51-111-0008', address: 'Plot 22, F-7 Markaz, Islamabad',                     latitude: 33.7197, longitude: 73.0588, allergies: 'Morphine (nausea)',blood_type: 'O+', assigned_care_manager: STAFF[12], care_manager_name: 'Nadia Rehman', is_active: true, emergency_contact_name: 'Kashif Bano', emergency_contact_phone: '+92-300-8822222' },
  { id: 9,  mr_number: 'MR-2024-009', full_name: 'Abdul Rehman',    first_name: 'Abdul',    last_name: 'Rehman',   age: 76, date_of_birth: '1948-03-14', gender: 'M', gender_display: 'Male',   primary_diagnosis: 'Parkinson\'s Disease Stage IV + Dysphagia',        phone: '+92-51-111-0009', address: 'House 5, Street 2, I-8/3, Islamabad',                latitude: 33.6844, longitude: 73.0479, allergies: 'Haloperidol',     blood_type: 'A+', assigned_care_manager: STAFF[7],  care_manager_name: 'Hina Malik',  is_active: true, emergency_contact_name: 'Farida Rehman', emergency_contact_phone: '+92-300-7733333' },
  { id: 10, mr_number: 'MR-2024-010', full_name: 'Zainab Mirza',    first_name: 'Zainab',   last_name: 'Mirza',    age: 28, date_of_birth: '1996-08-18', gender: 'F', gender_display: 'Female', primary_diagnosis: 'Lupus (SLE) — Active Flare Management',             phone: '+92-51-111-0010', address: 'Flat 4B, Margalla Heights, E-11, Islamabad',          latitude: 33.7003, longitude: 73.0259, allergies: 'NKDA',           blood_type: 'AB-',assigned_care_manager: STAFF[7],  care_manager_name: 'Hina Malik',  is_active: true, emergency_contact_name: 'Umar Mirza', emergency_contact_phone: '+92-300-6644444' },
  { id: 11, mr_number: 'MR-2024-011', full_name: 'Ghulam Mustafa',  first_name: 'Ghulam',   last_name: 'Mustafa',  age: 83, date_of_birth: '1941-05-30', gender: 'M', gender_display: 'Male',   primary_diagnosis: 'Hip Fracture Post-ORIF — Long-Term Home Nursing',   phone: '+92-51-111-0011', address: 'House 9, Street 1, G-6/2, Islamabad',                latitude: 33.7207, longitude: 73.0650, allergies: 'Codeine',        blood_type: 'B+', assigned_care_manager: STAFF[12], care_manager_name: 'Nadia Rehman', is_active: true, emergency_contact_name: 'Faisal Mustafa', emergency_contact_phone: '+92-300-5555555' },
];
...
export const ROLE_CONFIG = {
  super_admin:     { label: 'Super Admin',     nav: ['overview', 'bookings', 'live-tracking', 'staff', 'patients', 'patient-360', 'therapy', 'admin-hr', 'accounts', 'billing', 'crm', 'lms', 'reports', 'analytics', 'users'] },
  admin:           { label: 'Admin',           nav: ['overview', 'bookings', 'live-tracking', 'patients', 'patient-360', 'therapy', 'admin-hr', 'crm', 'lms', 'reports', 'analytics'] },
  branch_manager:  { label: 'Branch Manager',  nav: ['overview', 'bookings', 'live-tracking', 'patients', 'patient-360', 'lms', 'reports', 'analytics'] },
  care_manager:    { label: 'Care Manager',    nav: ['overview', 'bookings', 'live-tracking', 'patients', 'patient-360', 'therapy'] },
  nurse:           { label: 'Nurse / Doctor',  nav: ['overview', 'bookings', 'live-tracking', 'patients', 'patient-360'] },
